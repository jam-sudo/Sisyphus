...
**Prospective generalization is *worse* than retrospective** (3.21 &gt; 2.731 overall), reversing the earlier "favorable direction" reading. That reading (N=15, 2.402 &lt; 2.731) was a small-sample / curation artifact — the exact under-powering the cherry-picking audit flagged. The expanded set was built two ways:
